            ...
            <!--  debut contenu -->
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Message contact</h1>
                             ...
                             if ($_GET["message"]=="supechoue"){
                                ...
                                echo '<p style="color:green;">La supression a été effectué !</p>';
                                    ...
                                    try{
                                        ...
                                        $requete1 =  "SELECT id,nom,mail,telephone,msg FROM contact";
                                        ...
                                        foreach($connexion->query($requete1) as $row){
                                            ...
                                            echo "<td>" . $row['msg'] . "</td>";
                                            echo '<td style="text-align:center"><a href="contact_supprimer.php?id='.$row['id'].'"><img src="images/croix.png" alt="Efface"/></a></td></tr>';
                                        }
                                        echo "</tbody>";
                                        echo "</table>";
                                    }
