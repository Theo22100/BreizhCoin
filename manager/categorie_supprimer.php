...
if ($_SESSION['CONNECTE']!='YES'){
    header('Location: Projet/login.php');
                ...
                try{
                    ...
                    $requetedel =  "DELETE FROM `categorie` WHERE id= :id";
                    ...
                    header("Location: list_categories.php?message=supechoue");
                }

                header("Location: list_categories.php?message=supreussie");
